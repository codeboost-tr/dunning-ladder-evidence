...
Published a governed dunning-ladder skill to the runx registry at codeboost-tr/dunning-ladder. The skill reads an overdue receivable and a cadence policy, decides the next reminder step within the cap, and escalates (exit 1) once the cap is exhausted.
...
- **Public URL:** https://runx.ai/x/codeboost-tr/dunning-ladder@sha-5a9176c1fd75
...
```bash
runx add codeboost-tr/dunning-ladder@sha-5a9176c1fd75 --registry https://api.runx.ai
runx skill codeboost-tr/dunning-ladder@sha-5a9176c1fd75 --registry https://api.runx.ai \
